...
# Last updated: 2026-06-13 (Session 10 — Agent Zero Task Mode Boundary repair — ad-hoc stop behavior confirmed GREEN)
...
| agent-zero-desk | MGMT-XPS | 50080 | RUNNING — model: qwen2.5-coder:7b VM101 GPU, Task Mode Detection active (Runbook Mode / Ad-Hoc Mode), sentinel_check hallucination fixed, ad-hoc stop proven GREEN (session 10) | 2026-06-13 |
