...
# Last updated: 2026-06-13 (Session 12 — Agent Zero Notion MCP access restored — 22 tools, search + read + write all GREEN)
...
| agent-zero-desk | MGMT-XPS | 50080 | RUNNING — model: qwen2.5-coder:7b VM101 GPU, Task Mode Detection GREEN (S11), Runbook Mode GREEN (S11), Rule 2 docker prune=RED (S11), sentinel_verdict in all reports (S11), Notion MCP active: 22 tools, authenticated search/read/write via @notionhq/notion-mcp-server (S12) | 2026-06-13 |
